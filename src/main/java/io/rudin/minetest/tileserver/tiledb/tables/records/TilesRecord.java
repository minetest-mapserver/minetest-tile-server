...
public class TilesRecord extends UpdatableRecordImpl<TilesRecord> implements Record6<Integer, Integer, Integer, Long, byte[], Integer> {

    private static final long serialVersionUID = -903638213;
    ...
    /**
     * Setter for <code>tiles.layerid</code>.
     */
    ...
    /**
     * Getter for <code>tiles.layerid</code>.
     */
     ...
     */
    @Override
    public Row6<Integer, Integer, Integer, Long, byte[], Integer> fieldsRow() {
     ...
     */
    @Override
    public Row6<Integer, Integer, Integer, Long, byte[], Integer> valuesRow() {
     ...
     */
    @Override
    public TilesRecord value6(Integer value) {
        setLayerid(value);
        return this;
    }
     ...
     */
    @Override
    public TilesRecord values(Integer value1, Integer value2, Integer value3, Long value4, byte[] value5, Integer value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TilesRecord(Integer x, Integer y, Integer z, Long mtime, byte[] tile, Integer layerid) {
        super(Tiles.TILES);
