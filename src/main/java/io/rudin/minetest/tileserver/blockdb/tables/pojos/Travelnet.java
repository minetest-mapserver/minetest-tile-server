...
public class Travelnet implements Serializable {

    private static final long serialVersionUID = -1483960590;
    ...
    public Travelnet(Travelnet value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("Travelnet (");
