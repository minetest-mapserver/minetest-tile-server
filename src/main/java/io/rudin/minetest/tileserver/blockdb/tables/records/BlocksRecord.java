...
public class BlocksRecord extends UpdatableRecordImpl<BlocksRecord> implements Record5<Integer, Integer, Integer, byte[], Timestamp> {

    private static final long serialVersionUID = -362063997;
     ...
     */
    @Override
    public BlocksRecord value5(Timestamp value) {
        setMtime(value);
        return this;
    }
     ...
     */
    @Override
    public BlocksRecord values(Integer value1, Integer value2, Integer value3, byte[] value4, Timestamp value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BlocksRecord(Integer posx, Integer posy, Integer posz, byte[] data, Timestamp mtime) {
        super(Blocks.BLOCKS);
